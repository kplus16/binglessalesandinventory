...
Public Class SALESREPORTCRYS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BinglesSalesAndInventory.SALESREPORTCRYS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALESREPORTCRYS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALESREPORTCRYS = New SALESREPORTCRYS()
        rpt.Site = Me.Site
        Return rpt
    End Function
